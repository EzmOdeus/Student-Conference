...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="pt-24 text-center md:pt-32 pb-20 min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8  items-center">
          <div className={`transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            <div className="flex flex-wrap gap-4 mb-6 justify-center">
              ...
              <div className="flex items-center gap-2 bg-purple-800/50 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <span className="text-sm">١٠ صباحًا - ٣ مساءً</span>
              </div>
              <div className="flex items-center gap-2 bg-purple-800/50 backdrop-blur-sm px-4 py-2 rounded-full">
                <MapPin className="text-yellow-400" size={16} />
                <span className="text-sm">القاعة الزرقاء بكلية التمريض بجامعة الإسكندرية</span>
              </div>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-purple-200">
              ...
              <br />
              <span className="text-3xl md:text-4xl">لكلية التربية النوعية</span>
            </h1>
            ...
            <div className="flex flex-wrap  justify-center gap-4">
              <a href="#registration" className="px-8 py-4 bg-yellow-500 hover:bg-yellow-400 text-purple-900 rounded-lg font-bold transition-all shadow-lg hover:shadow-xl">
                سجل الآن
              </a>
              <a href="#about" className="px-8 py-4 bg-purple-800/50 backdrop-blur-sm hover:bg-purple-800 border border-purple-700 rounded-lg font-bold transition-all">
                اكتشف المزيد
              </a>
            </div>
          </div>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2">
          <div className="animate-bounce">
            <a href="#about" className="inline-block rounded-full p-2 bg-purple-800/50 backdrop-blur-sm hover:bg-purple-700">
